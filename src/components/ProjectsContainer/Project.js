...
const Project = (props) => {
  ...
  return (
    ...
    >
      <div id="image" className="p-2 md:p-4 w-full lg:w-2/6 rounded shadow-sm ">
        <div
      ...
      <div id="textblock" className="w-full p-2 lg:w-4/6">
        ...
        <div id="description" className="pt-0 md:pt-4 flex flex-wrap text-left">
          <span className="w-full text-xs md:text-md">{data.description}</span>
          <div className="w-1/2 ">
            <p
              className={`${
                isDarkMode
